"""
Time Encoding Module (TGAT-based)
===================================
...
class TimeEncode(torch.nn.Module):
  ...
  def forward(self, t):
    ...
    # ============================================================================
    # MODIFIED: Return zero tensors to disable time encoding for ablation study
    # To revert to original behavior, uncomment the original code below and
    # comment out/remove the zero tensor creation code
    # ============================================================================
    
    # Create zero tensor with same shape as original output: [batch_size, seq_len, dimension]
    #batch_size, seq_len = t.shape
    #output = torch.zeros(batch_size, seq_len, self.dimension, device=t.device, dtype=t.dtype)
    
    # ============================================================================
    # ORIGINAL CODE (commented out for easy reversion):
    # ============================================================================
